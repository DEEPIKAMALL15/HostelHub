    ...
    <div className= ' bg-[#F6F9FC] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32 '>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    <h1 className='text-4xl font-bold mb-4 h-8 md:h-9 invert opacity-80' >HostelHub</h1>
                    <p className='text-sm'>
                        Discover amazing places to stay, from boutique hostels to cozy private rooms and shared spaces.
                    </p>
