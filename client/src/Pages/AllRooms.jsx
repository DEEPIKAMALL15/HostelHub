      ...
      <div>
            ...
            {filteredRooms.map((room)=>(
                <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
                    ...
                    src={room.images[0]} alt="Hostel-img" title='View Room Details' className='max-h-65 md:w-1/2 rounded-xl shadow-lg object-cover cursor-pointer'/>
                    <div className='md:1/2 flex flex-col gap-2'>
                        ...
                        <p className='text-xl font-medium text-gray-700'>
                            {import.meta.env.VITE_CURRENCY}. {room.pricePerNight} / Night
                        </p>
